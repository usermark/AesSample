...
public final class SunSecureRandom implements java.io.Serializable {

    private static final long serialVersionUID = 3581829991155417889L;

    private static final int DIGEST_SIZE = 20;
//    private transient MessageDigest digest;
    private transient SHA digest;
    private byte[] state;
     ...
     * @param seed the seed.
     */
    private SunSecureRandom(byte seed[]) {
        init(seed);
    }
...
//
//        private static final SunSecureRandom seeder;
//
//        static {
//            /*
...
//             */
//            seeder = new SunSecureRandom(SeedGenerator.getSystemEntropy());
